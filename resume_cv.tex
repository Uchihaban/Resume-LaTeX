...
\name{郑露露}{}
\address{广东工业大学，广州，中国 }
\mobile{(+86) 15521121526}

\email{luluaban@163.com}
\homepage{blog.csdn.net/lulu950817}
\github{Uchihaban}
% \linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{}{Lulu Zheng {\enskip\cdotp\enskip} Resume}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/engineer-exp1.tex}
\input{cv-sections/engineer-exp2.tex}
